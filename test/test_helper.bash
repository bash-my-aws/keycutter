...
setup_test_environment() {
    ...
    mkdir -p "$TEST_HOME/.ssh/keycutter/"{keys,agents,hosts,scripts,controlmaster/sockets}
...
mock_keycutter_environment() {
    ...
    mkdir -p "$KEYCUTTER_CONFIG_DIR"/{keys,agents,hosts,scripts,controlmaster/sockets}
